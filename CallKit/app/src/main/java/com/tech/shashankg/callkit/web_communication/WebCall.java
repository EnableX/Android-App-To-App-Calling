...
public class WebCall extends AsyncTask<Void, Void, String> {
    ...
    private Boolean isfirebasedApi = false;
    private Boolean isAuthenticated = false;
    private JSONObject object = null;
    ProgressDialog dialog;

    public WebCall(Context context, WebResponse callback, JSONObject object,
                   String urlPath, int callCode, Boolean isGetCall, Boolean isAuthenticated, boolean isfirebasedApi) {
        ...
        this.isfirebasedApi = isfirebasedApi;
    ...
    private String callPostCallWithJSON() {
        ...
        try {
            ...
            if (isfirebasedApi) {
                ...
                url = new URL(WebConstants.kBaseURL + urlPath);
            }
            Log.e("Weburl", String.valueOf(url));
            httpURLConnection = (HttpURLConnection) url.openConnection();
            httpURLConnection.setReadTimeout(60000);
